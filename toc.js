/* QUTAIFAN guide TOC — builds from anchored headings (h2[id], h3[id]).
   Left rail ≥1200px, collapsible "Jump to" dropdown below. Self-contained. */
(function () {
  var heads = Array.prototype.slice.call(document.querySelectorAll('h2[id], h3[id]'));
  if (heads.length < 3) return;
  var STYLE =
    '.qf-toc{position:fixed;top:96px;left:max(12px,calc(50vw - 780px));width:200px;max-height:70vh;' +
    'overflow-y:auto;font-size:.78rem;line-height:1.45;display:none;z-index:40}' +
    '@media(min-width:1200px){.qf-toc{display:block}}' +
    ...
    '@media(min-width:1200px){.qf-jump{display:none}}' +
  ...
  if (firstH2) firstH2.parentNode.insertBefore(jump, firstH2);
